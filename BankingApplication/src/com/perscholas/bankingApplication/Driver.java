...
public class Driver {
	public static void main(String[] args)  {
		...
		Account accountTwo = new SavingsAccount("edward","password2",true,true,false,true,5000);
		Account accountThree = new CheckingAccount("sam","password3",true,true,true,false,5000);
		Account accountFour = new SavingsAccount("peter","password4",true,true,false,true,5000);
		Account accountFive = new CheckingAccount("kian","password5",true,false,true,false,5000);
		Account accountSix = new SavingsAccount("philips","password6",true,true,false,true,5000);
		Account accountSeven = new CheckingAccount("john","password7",true,true,true,false,5000);
		Account accountEight = new SavingsAccount("calvin","password8",true,true,false,true,5000);
		Account accountNine = new CheckingAccount("david","password9",true,false,true,false,5000);
		Account accountTen = new SavingsAccount("howard","password10",false,true,false,true,5000);
		...
		if(input1.equals(acc.getUserName()) && input2.equals(acc.getPassword())) {
			...
			System.out.print("Please enter a number between 1 - 5 :");  i = scan.nextInt();
			System.out.println("-------------------------------------------------------");
			...
			if(i==1) {
				...
				do {
					...
					System.out.print("Please enter a number between 1 - 3 :");input4 = scan.nextInt();
					
					double input3 = 0;
					if(input4==1) {
						System.out.println("Enter the deposit amount:"); input3 = scan.nextDouble();
						...
						System.out.println("Enter the withdraw amount:"); input3 = scan.nextDouble();
